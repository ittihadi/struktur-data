...
int main()
{
    ...
    updateData(head, 2, 25);

    printf("\nLinked list setelah update:\n");
    traversal(head);

    // Update di posisi tidak valid
    printf("\nMemberbarui data pada posisi 5:\n");
    updateData(head, 5, 50);
...
void judul()
{
    printf("Program Perbarui Data Circular Singly Linked List\n");
