...
void        insert_quadratic(HashEntry *hash_table, int key, const char *value);
const char *search_quadratic(HashEntry *hash_table, int key);
...
int main()
{
    ...
    insert_quadratic(hash_table, key, "Halo!");
    printf("\n");

    int key2 = 9202;
    printf("Memasukkan data dengan key %d\n", key2);
    insert_quadratic(hash_table, key2, "Hai!");
    printf("\n");

    printf("Mengakses data dengan key %d\n", key);
    const char *res = search_quadratic(hash_table, key);
    ...
    printf("Mengakses data dengan key %d\n", key2);
    res = search_quadratic(hash_table, key2);
...
void judul()
{
    printf("Program Implementasi Penanganan Kolisi dengan Quadratic Probing\n");
